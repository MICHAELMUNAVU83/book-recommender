...
class ReadingListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading_list" do
    assert_difference("ReadingList.count") do
      post reading_lists_url, params: { reading_list: { book_genre: @reading_list.book_genre, book_name: @reading_list.book_name } }
    end
  ...
  test "should update reading_list" do
    patch reading_list_url(@reading_list), params: { reading_list: { book_genre: @reading_list.book_genre, book_name: @reading_list.book_name } }
